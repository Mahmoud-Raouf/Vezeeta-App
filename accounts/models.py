...
class Profile(models.Model):
    ...
    surname         = models.CharField(_("اللقب"), max_length=20)
    subtitle        = models.TextField(_("نبذه عنك"), max_length=70)
    ...
    image           = models.ImageField(_("profile_image"), blank=True, null=True)
    ...
    type_doctors    = models.CharField(_("النوع"), choices=TYPE_OF_PERSON, default='M' ,max_length=20)
    doctor          = models.CharField(_("دكتور ؟"),choices=DOCTOR_IN , max_length=50)
    Specialist_doctor = models.CharField(_("متخصص فى ؟"), max_length=50)
    rating          = models.PositiveIntegerField(_("التقييم"),default=0)
